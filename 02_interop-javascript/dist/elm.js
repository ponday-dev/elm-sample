...
var _user$project$Counter$inc = _elm_lang$core$Native_Platform.outgoingPort(
	'inc',
	function (v) {
		return v;
	});
var _user$project$Counter$dec = _elm_lang$core$Native_Platform.outgoingPort(
	'dec',
	function (v) {
		return v;
	});
		...
		switch (_p0.ctor) {
			case 'Increment':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Counter$inc(model)
				};
			case 'Decrement':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Counter$dec(model)
				};
			default:
				return {ctor: '_Tuple2', _0: _p0._0, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Counter$suggestions = _elm_lang$core$Native_Platform.incomingPort('suggestions', _elm_lang$core$Json_Decode$int);
var _user$project$Counter$Suggest = function (a) {
	return {ctor: 'Suggest', _0: a};
};
var _user$project$Counter$subscriptions = function (model) {
	return _user$project$Counter$suggestions(_user$project$Counter$Suggest);
};
...
if (typeof _user$project$Counter$main !== 'undefined') {
    _user$project$Counter$main(Elm['Counter'], 'Counter', undefined);
}
